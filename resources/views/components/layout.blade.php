    ...
    <div class="min-h-full">
        <nav class="bg-gray-800" x-data="{ open_mobile_menu: false }">
                            ...
                            @auth
                                ...
                                <div x-data="{ open: false }" class="relative ml-3">
                                    ...
                                    <div x-show="open" @click.away="open = false"
                                        ...
                                        <form method="POST" action="/logout" class="confirm-dialog-form">
                                            @csrf
                                            <button type="submit"
                                ...
                                <span class="hidden sm:inline-block sm:ml-2 text-sm font-medium text-white">{{ Auth::user()->name }}</span>
                            @else
                                <a href="/signup"
                                    class="hidden rounded-md bg-gray-800 px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white md:block"
            ...
            @auth
                ...
                <div class="md:hidden" id="mobile-menu" x-show="open_mobile_menu">
                    <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                        ...
                        @endphp
                        <a href="/"
                            class="block rounded-md px-3 py-2 text-base font-medium {{ request()->is('/') ? $Current : $Default }}"
